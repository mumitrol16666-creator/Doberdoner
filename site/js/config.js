  ...
  menu: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          // На бумажном меню в зале: «курица 3520 / говядина 5420». В меню kamiqr вариант 5420 — «с говяжьей котлетой».
          id: 'chicago', name: 'Чикаго Блюз', price: 3520, image: 'img/chicago.jpg', badge: 'Много мяса',
          desc: 'Три котлеты — это не шутка: куриные или говяжьи на выбор, тянущаяся моцарелла, маринованные огурцы, халапеньо и соусы BBQ и кетчуп.',
          groups: [{
            id: 'patty', title: 'Котлеты',
            options: [
              { id: 'chicken', name: 'Куриные', line: 'куриные котлеты', price: 0, def: true },
              { id: 'beef', name: 'Говяжьи', line: 'говяжьи котлеты', price: 1900 }
            ]
          }],
          extras: BURGER_EXTRAS
        },
